...
## Status
Pure Rust font discovery, parsing, subsetting, webfont processing, and TrueType hinting execution. **v0.2.2.**
11 crates in workspace, ~34 500 Rust SLOC, 1068 tests passing with all features enabled (0 failures, 2 skipped; 1006 passing under default features). M0–M7 milestones complete.
