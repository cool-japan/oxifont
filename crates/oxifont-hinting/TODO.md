...
- [x] Standalone crate for 0.2.1 — not yet consumed by the `oxifont` facade crate or any other workspace member; depend on `oxifont-hinting = "0.2.1"` directly
